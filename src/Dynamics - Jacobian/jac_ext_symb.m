function [J_gripper_symb,J_complete_symb,J_grip_bary_symb] = jac_ext_symb
...
% cannot perform jacobian with respect to symbolic functions (E.G.: x(t))
    ...
    [S_gripper_symb,S_complete_symb,S_grip_bary] = dir_kin_ext_symb;
    ...
    J_grip_bary_subs = subs(S_grip_bary,{q1_sym q2_sym q3_sym},{temp1 temp2 temp3});
    J_grip_bary_symb = jacobian(J_grip_bary_subs,[temp1 temp2 temp3]);
    J_grip_bary_symb = subs(J_grip_bary_symb,{temp1 temp2 temp3},{q1_sym q2_sym q3_sym});

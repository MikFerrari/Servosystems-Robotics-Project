...
for j = 1:nLinks 
    ...
    Jx = Jg_links{j}(1); Jy = Jg_links{j}(2); Jz = Jg_links{j}(3);
    Ixx = (-Jx+Jy+Jz)/2; Iyy = (Jx-Jy+Jz)/2; Izz = (Jx+Jy-Jz)/2;

    Jxy = -Jg_links{j}(4); Jyz = -Jg_links{j}(5); Jzx = -Jg_links{j}(6);
...
Phi_ext_a = [c_  Force;
             -Force' 0]; % Expressed in an auxiliary frame,
